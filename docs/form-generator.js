...
const ReactSurveyGenerator = ReactSurveyBuilder.default.ReactSurveyGenerator;
const ElementStore = ReactSurveyBuilder.default.ElementStore;
const formContainer = document.querySelector('#survey-generator');
  ...
  render() {
    ...
    return e(
      ReactSurveyGenerator, {
        download_path: '',
        back_action: '/react-survey-builder/index.html',
        back_name: 'Back',
        answer_data: {},
        action_name: 'Save',
        form_action: postUrl,
