...
const SurveyElementsEdit = ({ element, setElement, files = [], showCorrectColumn = false, showDescription = false, manualEditModeOff, updateElement }) => {
	...
	return (
		<div>
			...
			{(element.hasOwnProperty('required') || element.hasOwnProperty('readOnly') || element.hasOwnProperty('defaultToday') || (['Checkboxes', 'Checkbox'].indexOf(element.element) !== -1)) &&
				<Form.Group className="form-group mb-5">
			...
			{(element.element === 'Checkboxes' || element.element === 'RadioButtons' || element.element === 'ButtonList' || element.element === 'Checkbox') &&
				<Form.Group className="form-group mb-5">
